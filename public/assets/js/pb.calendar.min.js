jQuery(function($){
    ...
    var _pb_calendar = (function(target_, options_){
        ...
        this._target.append('<div class="top-frame">' +
            ...
            '<a href="#" class="control-btn prev-btn w-33"></a>'+
            '<div class="year-month-frame w-33">'+
            '<span class="month"></span>'+
            '<span class="year"></span>'+
            '</div>'+
            '<a href="#" class="control-btn next-btn w-33"></a>'+
            '</div>'+
            '</div>');
        ...
        this._target.append('<div class="calendar-head-frame">' +
            ...
            '<div class="col col-dayname">Thur</div>' +
    ...
    _pb_calendar.prototype.update_view = (function(){
        ...
        var makeDate = new Date(this._yyyy_mm_moment);



        var newPrevdate = makeDate.setMonth(makeDate.getMonth() - 1);
        newPrevdate = new Date(newPrevdate);
        var newNextdate = makeDate.setMonth(makeDate.getMonth() + 2);
        newNextdate = new Date(newNextdate);


        var predateData = '<span class="s_month">'+moment(newPrevdate).format(this._options['month_label_format'])+'</span>' +
            '<span class="s_year">'+moment(newPrevdate).format(this._options['year_label_format'])+'</span>';
        var nextdateData = '<span class="s_month">'+moment(newNextdate).format(this._options['month_label_format'])+'</span>' +
            '<span class="s_year">'+moment(newNextdate).format(this._options['year_label_format'])+'</span>';

        this._prev_month_btn.html(predateData);
        this._next_month_btn.html(nextdateData);
